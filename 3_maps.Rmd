...
### 9.2
Create a map of the Bodish and add minimap with argument `minimap = TRUE`:
```{r, echo = FALSE}
...
### 9.3
Download [80. feature from WALS](wals.info/feature/80A) using `wals.feature("80a")` and draw a map:
```{r, echo = FALSE}
df <- wals.feature("80a")
map.feature(languages = df$language,
            features = df$`80a`,
